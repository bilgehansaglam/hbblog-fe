...
const SearchInput = () => {
  return (
    <div className="flex relative text-gray-500 focus-within:text-gray-700">
      <input
        type="search"
        className="rounded-2xl border-b-2 font-roboto   outline-none h-[30px] text-gray-500 lg:w-[450px] w-[350px]  pr-6 pl-[70px] py-6  placeholder-gray-300  dark:border-none"
